...
func AdminAnnouncementListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := messageadminannouncement.NewAdminAnnouncementListLogic(r.Context(), svcCtx)
		resp, err := l.AdminAnnouncementList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
