...
func AdminTemplateListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := messageadmin.NewAdminTemplateListLogic(r.Context(), svcCtx)
		resp, err := l.AdminTemplateList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
