...
for port in 8080 8081 8082 8083 8084 8085 8086 8088 8089 8090 8091 8092 8093 8094 8095 8096 8097 8098 8100 9088; do
  check_port "${port}" 'askxuan-.*-service|gateway|auth-serv|user|temple|master|booking|product|diy|order|payment|finance|review|audit|message|logistics|marketing|file|ai|media' "askXuan backend service ${port}"
done
